"use strict";(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f();}else if(typeof define==="function"&&define.amd){define([],f);}else{var g;if(typeof window!=="undefined"){g=window;}else if(typeof global!=="undefined"){g=global;}else if(typeof self!=="undefined"){g=self;}else{g=this;}g.ScopeMathematics=f();}})(function(){var define,module,exports;return function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a;}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r);},p,p.exports,r,e,n,t);}return n[i].exports;}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o;}return r;}()({1:[function(require,module,exports){const libPictSectionForm=require('../../source/Pict-Section-Form.js');module.exports=libPictSectionForm.PictFormApplication;module.exports.default_configuration=libPictSectionForm.PictFormApplication.default_configuration;module.exports.default_configuration.pict_configuration={"Product":"ScopeMathematics","DefaultFormManifest":require("./Scope-Mathematics_Manifest.json")};},{"../../source/Pict-Section-Form.js":21,"./Scope-Mathematics_Manifest.json":2}],2:[function(require,module,exports){module.exports={"Scope":"ScopeMathematics","Sections":[{"Hash":"GlobalConfig","Name":"Global Configuration","Description":"Settings that affect calculations across all sections","MetaTemplates":[{"HashPostfix":"-Template-Wrap-Prefix","Template":"<h1>Scope Mathematics</h1><p>This example demonstrates cross-scope data access in solvers using <code>getGlobalFormData</code>, <code>resolveGlobalFormData</code>, <code>getSectionFormData</code>, and <code>getSectionTabularFormData</code>.</p><div><a href=\"#\" onclick=\"{~P~}.PictApplication.solve()\">[ solve ]</a> <a href=\"#\" onclick=\"{~P~}.views.PictFormMetacontroller.showSupportViewInlineEditor()\">[ debug ]</a></div><hr />"}],"Solvers":[{"Expression":"TotalItemsCost = resolveGlobalFormData(\"Summary.TotalItemsCost\")","Ordinal":3},{"Expression":"TotalPartsCost = resolveGlobalFormData(\"Summary.TotalPartsCost\")","Ordinal":3},{"Expression":"GrandTotal = TotalItemsCost + TotalPartsCost","Ordinal":3},{"Expression":"DiscountedTotal = GrandTotal * (1 - (TaxRate / 100))","Ordinal":3}]},{"Hash":"Items","Name":"Line Items","Description":"A table of items with quantities and prices","Groups":[{"Hash":"ItemList","Name":"Item List","Layout":"Tabular","RecordSetAddress":"Items.ItemList","RecordManifest":"ItemEditor","RecordSetSolvers":["LineTotal = Quantity * UnitPrice"]}],"Solvers":[{"Expression":"Summary.TotalItemsCost = SUM(ItemLineTotals)","Ordinal":2},{"Expression":"Summary.ItemCount = COUNT(ItemList)","Ordinal":2}]},{"Hash":"Parts","Name":"Parts Inventory","Description":"A second table to demonstrate cross-table data access","Groups":[{"Hash":"PartList","Name":"Parts","Layout":"Tabular","RecordSetAddress":"Parts.PartList","RecordManifest":"PartEditor","RecordSetSolvers":["PartTotal = PartQuantity * PartCost"]}],"Solvers":[{"Expression":"Summary.TotalPartsCost = SUM(PartTotals)","Ordinal":2},{"Expression":"Summary.PartCount = COUNT(PartList)","Ordinal":2}]},{"Hash":"CrossScope","Name":"Cross-Scope Calculations","Description":"Demonstrates reading data from other sections using scope functions","Solvers":[{"Expression":"CrossScopeItemTotal = getSectionFormData(\"Items\", \"Summary.TotalItemsCost\")","Ordinal":3},{"Expression":"CrossScopePartTotal = getSectionFormData(\"Parts\", \"Summary.TotalPartsCost\")","Ordinal":3},{"Expression":"CrossScopeGrandTotal = CrossScopeItemTotal + CrossScopePartTotal","Ordinal":3},{"Expression":"GlobalTaxRate = getGlobalFormData(\"TaxRate\")","Ordinal":3},{"Expression":"CrossScopeDiscounted = CrossScopeGrandTotal * (1 - (GlobalTaxRate / 100))","Ordinal":3},{"Expression":"FirstItemName = getSectionTabularFormData(\"Items\", \"ItemList\", 0, \"ItemName\")","Ordinal":3},{"Expression":"FirstItemTotal = getSectionTabularFormData(\"Items\", \"ItemList\", 0, \"LineTotal\")","Ordinal":3},{"Expression":"FirstPartName = getSectionTabularFormData(\"Parts\", \"PartList\", 0, \"PartName\")","Ordinal":3},{"Expression":"FirstPartTotal = getSectionTabularFormData(\"Parts\", \"PartList\", 0, \"PartTotal\")","Ordinal":3}]},{"Hash":"Summary","Name":"Summary","Description":"Aggregated totals computed from global scope"},{"Hash":"Documentation","Name":"","MetaTemplates":[{"HashPostfix":"-Template-Wrap-Prefix","Template":"<hr /><h2>Solver Reference</h2><p>This example uses three solver ordinals to demonstrate execution order and cross-scope data access.</p><h3>Ordinal 1 &mdash; Row-Level RecordSetSolvers</h3><p>These run once per row in each tabular group, computing values within a single record.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th><th>Description</th></tr><tr><td>Items</td><td><code>LineTotal = Quantity * UnitPrice</code></td><td>Multiplies quantity by unit price for each line item row.</td></tr><tr><td>Parts</td><td><code>PartTotal = PartQuantity * PartCost</code></td><td>Multiplies quantity by cost for each part row.</td></tr></table><h3>Ordinal 2 &mdash; Section Aggregation Solvers</h3><p>These run after row solvers and aggregate tabular data into summary values. The <code>[].Property</code> descriptor syntax extracts a flat array of values from each row for use with <code>SUM</code>.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th><th>Description</th></tr><tr><td>Items</td><td><code>Summary.TotalItemsCost = SUM(ItemLineTotals)</code></td><td>Sums all LineTotal values via the <code>Items.ItemList[].LineTotal</code> collection extraction descriptor.</td></tr><tr><td>Items</td><td><code>Summary.ItemCount = COUNT(ItemList)</code></td><td>Counts the number of rows in the ItemList array.</td></tr><tr><td>Parts</td><td><code>Summary.TotalPartsCost = SUM(PartTotals)</code></td><td>Sums all PartTotal values via the <code>Parts.PartList[].PartTotal</code> collection extraction descriptor.</td></tr><tr><td>Parts</td><td><code>Summary.PartCount = COUNT(PartList)</code></td><td>Counts the number of rows in the PartList array.</td></tr></table><h3>Ordinal 3 &mdash; Cross-Scope Solvers</h3><p>These run last and demonstrate the four cross-scope data access functions.</p><h4><code>resolveGlobalFormData(address)</code></h4><p>Resolves a value from the global form data by manyfest address, using the metacontroller's <code>viewMarshalDestination</code> and <code>pict.manifest</code>.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th></tr><tr><td>GlobalConfig</td><td><code>TotalItemsCost = resolveGlobalFormData(\"Summary.TotalItemsCost\")</code></td></tr><tr><td>GlobalConfig</td><td><code>TotalPartsCost = resolveGlobalFormData(\"Summary.TotalPartsCost\")</code></td></tr></table><h4><code>getGlobalFormData(hash)</code></h4><p>Gets a value from the global form data by descriptor hash, using the global manyfest's <code>getValueByHash</code>.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th></tr><tr><td>CrossScope</td><td><code>GlobalTaxRate = getGlobalFormData(\"TaxRate\")</code></td></tr></table><h4><code>getSectionFormData(sectionHash, hashOrAddress)</code></h4><p>Gets a value from a specific section view's data using that section's <code>sectionManifest</code> and <code>getValueByHash</code>. Allows one section's solver to read another section's computed values.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th></tr><tr><td>CrossScope</td><td><code>CrossScopeItemTotal = getSectionFormData(\"Items\", \"Summary.TotalItemsCost\")</code></td></tr><tr><td>CrossScope</td><td><code>CrossScopePartTotal = getSectionFormData(\"Parts\", \"Summary.TotalPartsCost\")</code></td></tr></table><h4><code>getSectionTabularFormData(sectionHash, groupHash, rowIndex, hashOrAddress)</code></h4><p>Gets a value from a specific row of a tabular group in another section. Resolves the tabular record set, indexes into it by row, and uses the group's <code>supportingManifest</code> to look up the value by hash. The <code>rowIndex</code> parameter accepts both numbers and strings (for arbitrary precision compatibility).</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th></tr><tr><td>CrossScope</td><td><code>FirstItemName = getSectionTabularFormData(\"Items\", \"ItemList\", 0, \"ItemName\")</code></td></tr><tr><td>CrossScope</td><td><code>FirstItemTotal = getSectionTabularFormData(\"Items\", \"ItemList\", 0, \"LineTotal\")</code></td></tr><tr><td>CrossScope</td><td><code>FirstPartName = getSectionTabularFormData(\"Parts\", \"PartList\", 0, \"PartName\")</code></td></tr><tr><td>CrossScope</td><td><code>FirstPartTotal = getSectionTabularFormData(\"Parts\", \"PartList\", 0, \"PartTotal\")</code></td></tr></table><h3>Computed Values (Ordinal 3)</h3><p>Standard arithmetic expressions that combine cross-scope results.</p><table border='1' cellpadding='6' cellspacing='0' style='border-collapse:collapse;margin-bottom:1em;width:100%'><tr style='background:var(--theme-color-border-default, #ddd)'><th>Section</th><th>Expression</th><th>Description</th></tr><tr><td>GlobalConfig</td><td><code>GrandTotal = TotalItemsCost + TotalPartsCost</code></td><td>Sum of item and part totals pulled via resolveGlobalFormData.</td></tr><tr><td>GlobalConfig</td><td><code>DiscountedTotal = GrandTotal * (1 - (TaxRate / 100))</code></td><td>Applies the discount rate to the grand total.</td></tr><tr><td>CrossScope</td><td><code>CrossScopeGrandTotal = CrossScopeItemTotal + CrossScopePartTotal</code></td><td>Sum of totals pulled via getSectionFormData.</td></tr><tr><td>CrossScope</td><td><code>CrossScopeDiscounted = CrossScopeGrandTotal * (1 - (GlobalTaxRate / 100))</code></td><td>Applies tax rate pulled via getGlobalFormData.</td></tr></table>"}]}],"Descriptors":{"TaxRate":{"Name":"Discount Rate (%)","Hash":"TaxRate","DataType":"Number","Default":10,"PictForm":{"Section":"GlobalConfig","Row":1,"Width":4}},"CurrencySymbol":{"Name":"Currency Symbol","Hash":"CurrencySymbol","DataType":"String","Default":"$","PictForm":{"Section":"GlobalConfig","Row":1,"Width":4}},"ProjectName":{"Name":"Project Name","Hash":"ProjectName","DataType":"String","Default":"Sample Project","PictForm":{"Section":"GlobalConfig","Row":1,"Width":4}},"Items.ItemList":{"Name":"Line Items","Hash":"ItemList","DataType":"Array","Default":[{"ItemName":"Widget Alpha","Quantity":5,"UnitPrice":12.50,"LineTotal":62.50},{"ItemName":"Widget Beta","Quantity":3,"UnitPrice":25.00,"LineTotal":75.00},{"ItemName":"Widget Gamma","Quantity":10,"UnitPrice":8.75,"LineTotal":87.50}],"PictForm":{"Section":"Items","Group":"ItemList"}},"Items.ItemList[].LineTotal":{"Hash":"ItemLineTotals"},"Parts.PartList":{"Name":"Parts","Hash":"PartList","DataType":"Array","Default":[{"PartName":"Bolt M6x20","PartQuantity":100,"PartCost":0.15,"PartTotal":15.00},{"PartName":"Washer M6","PartQuantity":100,"PartCost":0.05,"PartTotal":5.00},{"PartName":"Nut M6","PartQuantity":50,"PartCost":0.10,"PartTotal":5.00}],"PictForm":{"Section":"Parts","Group":"PartList"}},"Parts.PartList[].PartTotal":{"Hash":"PartTotals"},"Summary.TotalItemsCost":{"Name":"Total Items Cost","Hash":"TotalItemsCost","DataType":"Number","PictForm":{"Section":"Summary","Row":1,"Width":3}},"Summary.TotalPartsCost":{"Name":"Total Parts Cost","Hash":"TotalPartsCost","DataType":"Number","PictForm":{"Section":"Summary","Row":1,"Width":3}},"Summary.ItemCount":{"Name":"Item Row Count","Hash":"ItemCount","DataType":"Number","PictForm":{"Section":"Summary","Row":1,"Width":3}},"Summary.PartCount":{"Name":"Part Row Count","Hash":"PartCount","DataType":"Number","PictForm":{"Section":"Summary","Row":1,"Width":3}},"GrandTotal":{"Name":"Grand Total (Global Scope)","Hash":"GrandTotal","DataType":"Number","PictForm":{"Section":"GlobalConfig","Row":2,"Width":4}},"DiscountedTotal":{"Name":"After Discount (Global Scope)","Hash":"DiscountedTotal","DataType":"Number","PictForm":{"Section":"GlobalConfig","Row":2,"Width":4}},"CrossScope.CrossScopeItemTotal":{"Name":"Items Total (via getSectionFormData)","Hash":"CrossScopeItemTotal","DataType":"Number","PictForm":{"Section":"CrossScope","Row":1,"Width":6}},"CrossScope.CrossScopePartTotal":{"Name":"Parts Total (via getSectionFormData)","Hash":"CrossScopePartTotal","DataType":"Number","PictForm":{"Section":"CrossScope","Row":1,"Width":6}},"CrossScope.CrossScopeGrandTotal":{"Name":"Grand Total (cross-scope sum)","Hash":"CrossScopeGrandTotal","DataType":"Number","PictForm":{"Section":"CrossScope","Row":2,"Width":4}},"CrossScope.GlobalTaxRate":{"Name":"Tax Rate (via getGlobalFormData)","Hash":"GlobalTaxRate","DataType":"Number","PictForm":{"Section":"CrossScope","Row":2,"Width":4}},"CrossScope.CrossScopeDiscounted":{"Name":"Discounted Total (cross-scope)","Hash":"CrossScopeDiscounted","DataType":"Number","PictForm":{"Section":"CrossScope","Row":2,"Width":4}},"CrossScope.FirstItemName":{"Name":"First Item Name (tabular scope)","Hash":"FirstItemName","DataType":"String","PictForm":{"Section":"CrossScope","Row":3,"Width":3}},"CrossScope.FirstItemTotal":{"Name":"First Item Total (tabular scope)","Hash":"FirstItemTotal","DataType":"Number","PictForm":{"Section":"CrossScope","Row":3,"Width":3}},"CrossScope.FirstPartName":{"Name":"First Part Name (tabular scope)","Hash":"FirstPartName","DataType":"String","PictForm":{"Section":"CrossScope","Row":3,"Width":3}},"CrossScope.FirstPartTotal":{"Name":"First Part Total (tabular scope)","Hash":"FirstPartTotal","DataType":"Number","PictForm":{"Section":"CrossScope","Row":3,"Width":3}}},"ReferenceManifests":{"ItemEditor":{"Scope":"ItemEditor","Descriptors":{"ItemName":{"Name":"Item Name","Hash":"ItemName","DataType":"String","Default":"(new item)","PictForm":{"Section":"Items","Group":"ItemList"}},"Quantity":{"Name":"Qty","Hash":"Quantity","DataType":"Number","Default":1,"PictForm":{"Section":"Items","Group":"ItemList"}},"UnitPrice":{"Name":"Unit Price","Hash":"UnitPrice","DataType":"Number","Default":0,"PictForm":{"Section":"Items","Group":"ItemList"}},"LineTotal":{"Name":"Line Total","Hash":"LineTotal","DataType":"Number","PictForm":{"Section":"Items","Group":"ItemList"}}}},"PartEditor":{"Scope":"PartEditor","Descriptors":{"PartName":{"Name":"Part Name","Hash":"PartName","DataType":"String","Default":"(new part)","PictForm":{"Section":"Parts","Group":"PartList"}},"PartQuantity":{"Name":"Qty","Hash":"PartQuantity","DataType":"Number","Default":1,"PictForm":{"Section":"Parts","Group":"PartList"}},"PartCost":{"Name":"Unit Cost","Hash":"PartCost","DataType":"Number","Default":0,"PictForm":{"Section":"Parts","Group":"PartList"}},"PartTotal":{"Name":"Part Total","Hash":"PartTotal","DataType":"Number","PictForm":{"Section":"Parts","Group":"PartList"}}}}}};},{}],3:[function(require,module,exports){module.exports={"name":"fable-serviceproviderbase","version":"3.0.19","description":"Simple base classes for fable services.","main":"source/Fable-ServiceProviderBase.js","scripts":{"start":"node source/Fable-ServiceProviderBase.js","test":"npx quack test","tests":"npx quack test -g","coverage":"npx quack coverage","build":"npx quack build","types":"tsc -p ./tsconfig.build.json","check":"tsc -p . --noEmit"},"types":"types/source/Fable-ServiceProviderBase.d.ts","mocha":{"diff":true,"extension":["js"],"package":"./package.json","reporter":"spec","slow":"75","timeout":"5000","ui":"tdd","watch-files":["source/**/*.js","test/**/*.js"],"watch-ignore":["lib/vendor"]},"repository":{"type":"git","url":"https://github.com/stevenvelozo/fable-serviceproviderbase.git"},"keywords":["entity","behavior"],"author":"Steven Velozo <steven@velozo.com> (http://velozo.com/)","license":"MIT","bugs":{"url":"https://github.com/stevenvelozo/fable-serviceproviderbase/issues"},"homepage":"https://github.com/stevenvelozo/fable-serviceproviderbase","devDependencies":{"@types/mocha":"^10.0.10","fable":"^3.1.62","quackage":"^1.0.58","typescript":"^5.9.3"}};},{}],4:[function(require,module,exports){/**
* Fable Service Base
...
module.exports.CoreServiceProviderBase=FableServiceProviderBase;},{"../package.json":3}],5:[function(require,module,exports){/**
...
module.exports.ExtensionViews={LifecycleVisualization:require('./views/support/Pict-View-PSF-LifeCycle-Visualization.js'),DebugViewer:require('./views/support/Pict-View-PSF-DebugViewer.js')};},{"./application/Pict-Application-Form.js":22,"./providers/Pict-Provider-DynamicLayout.js":26,"./providers/Pict-Provider-DynamicTemplates.js":30,"./providers/Pict-Provider-FormPersistence.js":31,"./providers/Pict-Provider-InputExtension.js":33,"./services/ManifestConversionToCSV.js":62,"./services/ManifestFactory.js":63,"./services/Pict-Service-DynamicFormDependencyManager.js":64,"./views/Pict-View-DynamicForm.js":79,"./views/Pict-View-Form-Metacontroller.js":80,"./views/support/Pict-View-PSF-DebugViewer.js":83,"./views/support/Pict-View-PSF-LifeCycle-Visualization.js":84,"./views/support/Pict-View-PSF-SupportBase.js":87}],22:[function(require,module,exports){const libPictApplication=require('pict-application');const libPictSectionForm=require('../Pict-Section-Form.js');/**
...
this.pict.addView('PictFormMetacontroller',{},libPictSectionForm.PictFormMetacontroller);}/**
	 ...
	 */marshalDataFromAppDataToDynamicViews(){this.pict.views.PictFormMetacontroller.marshalToView();}};module.exports=PictSectionFormApplication;/** @type {Record<string, any>} */module.exports.default_configuration={"Name":"A Simple Pict Forms Application","Hash":"PictFormsApp","MainViewportViewIdentifier":"PictFormMetacontroller","AutoSolveAfterInitialize":false,"pict_configuration":{"Product":"PictDefaultFormsApp"}};},{"../Pict-Section-Form.js":21,"pict-application":7}],23:[function(require,module,exports){const libPictProvider=require('pict-provider');// TODO: Pull this back to pict as a core service once we are happy with the shape.
...
this.lastSolveOutcome=tmpSolveOutcome;return tmpViewHashes;}}module.exports=PictDynamicSolver;module.exports.default_configuration=_DefaultProviderConfiguration;},{"./Pict-Provider-DynamicFormSolverBehaviors.js":23,"./Pict-Provider-ListDistilling.js":34,"./Pict-Provider-MetaLists.js":35,"./inputs/Pict-Provider-Input-AutofillTriggerGroup.js":40,"./inputs/Pict-Provider-Input-Chart.js":41,"./inputs/Pict-Provider-Input-DateTime.js":42,"./inputs/Pict-Provider-Input-EntityBundleRequest.js":43,"./inputs/Pict-Provider-Input-HTML.js":44,"./inputs/Pict-Provider-Input-Link.js":45,"./inputs/Pict-Provider-Input-Markdown.js":46,"./inputs/Pict-Provider-Input-PreciseNumber.js":47,"./inputs/Pict-Provider-Input-Select.js":48,"./inputs/Pict-Provider-Input-TabGroupSelector.js":49,"./inputs/Pict-Provider-Input-TabSectionSelector.js":50,"./inputs/Pict-Provider-Input-TabularTriggerGroup.js":51,"./inputs/Pict-Provider-Input-Templated.js":52,"./inputs/Pict-Provider-Input-TemplatedEntityLookup.js":53,"pict-provider":9}],29:[function(require,module,exports){const libPictProvider=require('pict-provider');/** @type {Record<string, any>} */const _DefaultProviderConfiguration={"ProviderIdentifier":"Pict-DynamicForms-DynamicTabularData","AutoInitialize":true,"AutoInitializeOrdinal":0,"AutoSolveWithApp":false};/**
...
`}/*
		 ...
		 *
		 */]};},{}],39:[function(require,module,exports){module.exports={"TemplatePrefix":"Pict-MT-Base","Templates":[/*
		 *
		 * [ Metacontroller Templates ]
		 *
		 */// the form "Header", rendered once before the dynamic views, after which come the section(s), then their group(s)
...
`},{"HashPostfix":"-TabularTemplate-Begin-Input-InputType-ReadOnly","Template":/*HTML*/`
		 ...
		 * [ Tabular Templates END ]
		 *
		 */]};},{}],40:[function(require,module,exports){const libPictSectionInputExtension=require('../Pict-Provider-InputExtension.js');/**
...
let tmpInputView=this.pict.views[pInput.PictForm.ViewHash];this.pict.providers.DynamicMetaLists.rebuildListByHash(pInput.PictForm.SelectOptionsPickList);this.pict.providers['Pict-Input-Select'].refreshSelectListTabular(tmpInputView,tmpInputView.getGroup(pInput.PictForm.GroupIndex),tmpInputView.getRow(pInput.PictForm.GroupIndex,pInput.PictForm.Row),pInput,pValue,pHTMLSelector,pRowIndex);tmpInputView.manualMarshalTabularDataToViewByInput(pInput,pRowIndex,tmpEventGUID);}/*
			...
			*/}return super.onAfterEventTabularCompletion(pView,pInput,pValue,pHTMLSelector,pRowIndex,pEvent,pTransactionGUID);}}module.exports=CustomInputHandler;},{"../Pict-Provider-InputExtension.js":33}],41:[function(require,module,exports){const libPictSectionInputExtension=require('../Pict-Provider-InputExtension.js');/**
 ...
 */class CustomInputHandler extends libPictSectionInputExtension{/**
	 ...
	 * @param {string} pTransactionGUID - The transaction GUID for the event dispatch.
	 * @returns {any} - The result of the data marshaling.
	 */onDataMarshalToFormTabular(pView,pGroup,pInput,pValue,pHTMLSelector,pRowIndex,pTransactionGUID){let tmpContent=this.getInputContent(pInput,pValue);if(tmpContent){this.pict.ContentAssignment.assignContent(this.getTabularContentDisplayInputID(pInput.Macro.RawHTMLID,pRowIndex),tmpContent);}return super.onDataMarshalToFormTabular(pView,pGroup,pInput,pValue,pHTMLSelector,pRowIndex,pTransactionGUID);}}module.exports=CustomInputHandler;},{"../Pict-Provider-InputExtension.js":33,"marked":5}],47:[function(require,module,exports){const libPictSectionInputExtension=require('../Pict-Provider-InputExtension.js');/**
 * CustomInputHandler class.
 *
 * @class
 * @extends libPictSectionInputExtension
...
let tmpTuiGridView=this.getViewGrid(tmpView,tmpGroup);if(tmpTuiGridView){tmpTuiGridView.tuiGrid.appendRow(JSON.parse(JSON.stringify(tmpNewObject)));}}}module.exports=TuiGridLayout;},{"../Pict-Provider-DynamicLayout.js":26,"./Pict-Layout-TuiGrid/Pict-Section-TuiGrid.js":60}],60:[function(require,module,exports){const libPictSectionTuiGrid=require('pict-section-tuigrid');/**
...
pChangeData.instance.View.setDataTabularByHash(pChangeData.instance.Group.GroupIndex,tmpChange.columnName,tmpRowIndex,tmpChange.value);}return super.changeHandler(pChangeData);}}module.exports=TuiGridLayout;},{"pict-section-tuigrid":11}],61:[function(require,module,exports){const libPictSectionGroupLayout=require('../Pict-Provider-DynamicLayout.js');class VerticalRecordLayout extends libPictSectionGroupLayout{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);/** @type {import('pict')} */this.pict;/** @type {import('pict')} */this.fable;/** @type {any} */this.log;}/**
	 * Generate a group layout template for a single-record dynamically generated group view.
	 *
	 * This is the standard name / field entry form that you're used to filling out for addresses
	 * and such.
...
return this.pict.parseTemplate(tmpTemplate,descriptor,fCallback,tmpContextArray,tmpScope,pState);}}module.exports=PictTemplateControlFromDynamicManifest;},{"pict-template":17}],66:[function(require,module,exports){const libPictTemplate=require('pict-template');/**
 * This is a template that will generate a Metatemplate input, for manual use of metatemplates.
 */class PictTemplateControlFromDynamicManifest extends libPictTemplate{/**
	 * @param {Object} pFable - The Fable Framework instance
	 * @param {Object} pOptions - The options for the service
...
const tmpTemplate=tmpMetatemplateGenerator.getInputMetatemplateTemplateReference(tmpView,descriptor.DataType,descriptor.PictForm.InputType,`getInput("${descriptor.PictForm.GroupIndex}","${descriptor.PictForm.RowIndex}","${descriptor.PictForm.InputIndex}")`);// Now parse it and return it.
return this.pict.parseTemplate(tmpTemplate,descriptor,fCallback,tmpContextArray,tmpScope,pState);}}module.exports=PictTemplateControlFromDynamicManifest;},{"pict-template":17}],67:[function(require,module,exports){const libPictTemplate=require('pict-template');/**
 * This is a template that will generate a Metatemplate input, for manual use of metatemplates.
...
tmpInput.PictForm.InputIndex=tmpRow.Inputs.length;tmpInputView.sectionManifest.addDescriptor(tmpInput.Address,tmpInput);tmpRow.Inputs.push(tmpInput);this.pict.providers.MetatemplateMacros.buildInputMacros(tmpInputView,tmpInput);// Now generate the metatemplate
let tmpTemplate=tmpMetatemplateGenerator.getInputMetatemplateTemplateReference(tmpInputView,tmpInput.DataType,tmpInput.PictForm.InputType,`getInput("0","0","${tmpInput.PictForm.InputIndex}")`);this.pict.parseTemplate(tmpTemplate,tmpInput,fCallback,[tmpInputView],tmpInputView,pState);return;}}module.exports=PictTemplateInputWithViewTemplate;},{"pict-template":17}],73:[function(require,module,exports){const libPictTemplate=require('pict-template');/**
 * This is a template that will generate a dynamic input using a provided dynamic view (by hash)
...
this.pict.views["Pict-Form-DebugViewer"].render();}/**
	 ...
	 */get isPictMetacontroller(){return true;}}module.exports=PictFormMetacontroller;/** @type {Record<string, any>} */module.exports.default_configuration={"AutoRender":true,"AutoPopulateDefaultObject":true,"AutoSolveBeforeRender":true,"AutoPopulateAfterRender":true,"DefaultRenderable":"Pict-Forms-Metacontainer","DefaultDestinationAddress":"#Pict-Form-Container","OnlyRenderDynamicSections":true,"MetaTemplateHash":"Pict-Forms-Metatemplate","Templates":[{"Hash":"Pict-Forms-Metatemplate","Template":"<!-- Pict-Forms-Metatemplate HAS NOT BEEN GENERATED; call pict.views.PictFormsMetatemplate.generateMetatemplate() to build the containers -->"}],"Renderables":[{"RenderableHash":"Pict-Forms-Metacontainer","TemplateHash":"Pict-Forms-Metatemplate","DestinationAddress":"#Pict-Form-Container"}]};},{"../services/Pict-Service-DynamicFormDependencyManager.js":64,"./Pict-View-DynamicForm.js":79,"./support/Pict-View-PSF-AppData-Visualization.js":82,"./support/Pict-View-PSF-DebugViewer.js":83,"./support/Pict-View-PSF-LifeCycle-Visualization.js":84,"./support/Pict-View-PSF-Solver-Visualization.js":85,"./support/Pict-View-PSF-SpecificSolve-Visualization.js":86,"pict-view":19}],81:[function(require,module,exports){const libPictProvider=require('pict-provider');/** @type {Record<string, any>} */const _DefaultProviderConfiguration={"ProviderIdentifier":"Pict-Form-SupportExtensions","AutoInitialize":true,"AutoInitializeOrdinal":0,"AutoSolveWithApp":false};/**
 * Represents a class that provides dynamic templates for the Pict form section provider.
 * @extends libPictProvider
...
return this.pict.manifest.objectAddressGeneration.generateAddressses(tmpData);}}module.exports=PictFormsAppData;module.exports.default_configuration=defaultViewConfiguration;},{"./Pict-View-PSF-SupportBase.js":87}],83:[function(require,module,exports){const libPictViewFormSupportBase=require(`./Pict-View-PSF-SupportBase.js`);const defaultViewConfiguration={ViewIdentifier:"Pict-Form-DebugViewer",DefaultRenderable:'Pict-Form-DebugViewer-Renderable',DefaultDestinationAddress:"#Pict-Form-Extensions-Container",RenderOnLoad:false,CSS:/*css*/`
...
pEvent.preventDefault();});/*
				* END of browser event code block
				* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */}}}module.exports=PictFormsSupportBase;module.exports.default_configuration=defaultViewConfiguration;},{"./Pict-Provider-PSF-Support.js":81,"pict-view":19}]},{},[1])(1);});
