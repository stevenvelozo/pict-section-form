...
/**
 * This is a template that will generate a Metatemplate input *TEMPLATE*, for low-level manual use of metatemplates.
 */
class PictTemplateMetatemplateInput extends libPictTemplate
{
	...
	constructor(pFable, pOptions, pServiceHash)
	{
		...
		this.addPattern('{~MetaTemplateInputTemplate:', '~}');
		this.addPattern('{~MTIT:', '~}');
	}
